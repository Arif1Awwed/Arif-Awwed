...
#### 🤖 Machine Learning & AI (Learned & Applied via Projects)
...
| Project | Key Tech | Description | Link |
| :--- | :--- | :--- | :---: |
| **E-Commerce Conversion Funnel** | SQL, Power BI, DAX | Analyzed 9,381 events across 5,000 users to uncover funnel conversion drop-offs. Built advanced SQL metrics and DAX semantic models to power a dynamic Power BI conversion optimization dashboard. | [🔗 View](https://github.com/Arif1Awwed/Ecommerce-Funnel-Analysis) |
| **Netflix Content Analysis** | MySQL, Power BI, DAX | Engineered a relational data pipeline in MySQL to clean and transform Netflix catalog metadata. Connected live to Power BI to visualize KPI metrics, release trends, and content ratio distributions. | [🔗 View](https://github.com/Arif1Awwed/Netflix) |
| **Customer Shopping Behavior** | Python, MySQL, Power BI | Processed and cleaned 3,900 customer shopping records in Python and synced to MySQL. Executed SQL analytics on demographics and spending habits, paired with a Power BI revenue dashboard. | [🔗 View](https://github.com/Arif1Awwed/Customer-Behavior-Data-Analyst) |
...
| Project | Key Tech | Description | Link |
| :--- | :--- | :--- | :---: |
| **Cafe Sales Multi-Environment** | Python, SQL, Power BI, Excel | Developed a standardized 5-step data quality framework to handle anomalies and duplicates across 10,000 rows. Validated performance and data parity across Python, SQL, Power Query, and Excel. | [🔗 View](https://github.com/Arif1Awwed/Data-Cleaning) |
| **Zepto E-Commerce Inventory** | SQL, Markdown | Conducted SQL-driven inventory analytics on 3,732 product items. Resolved pricing anomalies, standardized currencies, and generated actionable recommendations for stock management and pricing strategies. | [🔗 View](https://github.com/Arif1Awwed/Zepto-E-Commerce) |

---

### 📬 Contact Me

- 📧 Email: [arif623401@gmail.com](mailto:arif623401@gmail.com)
